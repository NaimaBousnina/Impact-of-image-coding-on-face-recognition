...
parser = argparse.ArgumentParser(description='do bmshj2018_hyperprior compression')
...
net = bmshj2018_hyperprior(quality=Quality, metric= Metric, pretrained=Pretrained).eval()
...
for filename in glob.glob(Image_path +'/**/*.png'):
    ...
    # Apply the image codind/decoding
